...
class ItchIO extends AppSource {
  ...
  String? _getDateVersion(Document document) {
    ...
    for (var abbrElement in abbrElements) {
      ...
      // Not every <abbr title="..."> on the page is a date — page authors use
      // the tag for ordinary abbreviations too. parseUtc would throw out of the
      // update check on the first such element; skip them instead.
      final DateTime? abbrDate = abbrTimeFormat.tryParseUtc(title);
      if (abbrDate == null) continue;
