...
class LiteAPKs extends AppSource {
  ...
  Future<APKDetails> getLatestAPKDetails(
    ...
    var liteAppId = loggingJsonDecode(res1.body, context: 'LiteAPKs: parsing app search response body')[0]['id'];
    if (liteAppId == null) {
    ...
    var json = loggingJsonDecode(res2.body, context: 'LiteAPKs: parsing app detail response body');
