...
class GitLab extends AppSource {
  ...
  Future<Map<String, List<String>>> search(
    ...
    var json = loggingJsonDecode(res.body, context: 'GitLab: parsing search results response body') as List<dynamic>;
  ...
  Future<APKDetails> getLatestAPKDetails(
    ...
    int? projectId = loggingJsonDecode(res0.body, context: 'GitLab: parsing project ID response body')['id'];
    if (projectId == null) {
    ...
    var json = loggingJsonDecode(res.body, context: 'GitLab: parsing releases response body') as List<dynamic>;
