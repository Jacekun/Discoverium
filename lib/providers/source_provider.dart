...
Map<String, dynamic> appJSONCompatibilityModifiers(Map<String, dynamic> json) {
  ...
  if (json['additionalSettings'] != null) {
    originalAdditionalSettings = Map<String, dynamic>.from(
      loggingJsonDecode(json['additionalSettings'], context: 'additionalSettings for app ${json['id']}'),
    );
  ...
  if (json['additionalData'] != null) {
    List<String> temp = List<String>.from(loggingJsonDecode(json['additionalData'], context: 'additionalData for app ${json['id']}'));
  ...
  factory App.fromJson(Map<String, dynamic> json) {
    ...
    return App(
      ...
      assumed2DlistToStringMapList(
        loggingJsonDecode((json['apkUrls'] ?? '[["placeholder", "placeholder"]]'), context: 'apkUrls for app ${json['id']}'),
      ),
      (json['preferredApkIndex'] ?? -1) as int,
      loggingJsonDecode(json['additionalSettings'], context: 'additionalSettings in App.fromJson for app ${json['id']}') as Map<String, dynamic>,
      json['lastUpdateCheck'] == null
          ? null
      ...
      otherAssetUrls: assumed2DlistToStringMapList(
        loggingJsonDecode((json['otherAssetUrls'] ?? '[]'), context: 'otherAssetUrls for app ${json['id']}'),
      ),
    );
  }
